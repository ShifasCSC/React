...
function AddProduct() {
  ...
  const handleSubmit = async(e) => {
    ...
    const {data}=await axios.post(`${api}/addproduct`,{productName, price, category, sizes,images})
    console.log(data);
    alert(data.msg)
    navigate('/sell')
  };
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white shadow-md rounded-md font-serif">
      ...
      <form onSubmit={handleSubmit}>
        {/* Product Name */}
        <div className="mb-4">
          <label className="block text-gray-700 mb-1" htmlFor="product-name">
            Product Name:   
          </label>
          <input
            type="text"
        ...
        <input
            ...
            accept="image/*"
            multiple
            className="mt-1 block w-1/2 text-sm text-gray-700 shadow-sm focus:ring-blue-500 focus:border-blue-500"
        />
        <img
            src={images}
            alt="Profile"
        ...
        <div className="mb-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-5 py-1 bg-gray-700 hover:text-black hover:bg-gray-500 text-white rounded"
            >
              +
            </button>
          </div>
        ...
        <label className="block text-gray-700 mb-2" htmlFor="price">
          ...
          <button
            ...
            className="w-full py-2 px-4 bg-gray-700 hover:text-black hover:bg-gray-500 text-white rounded-md mt-4"
          >
            + Add Size
          </button>
        </div>
        ...
        <div>
          <button
            type="submit"
            className="w-full py-2 px-4 bg-gray-700 hover:text-black hover:bg-gray-500 text-white rounded-md"
          >
            Submit Product
          </button>
        </div>
