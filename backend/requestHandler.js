...
export async function forgotPassword(req,res) {
    ...
    try{
        ...
        const info = await transporter.sendMail({
           ...
           subject: "for your email verification for password updation", // Subject line
           ...
           <body>
               ...
               <div class="email-container">
                   <p>Hello,</p>
                   <p>Please enter your new password by clicking the button below.</p>
                   <a href="http://localhost:5173/newpassword" class="btn">Verify Your Account</a>
               </div>
