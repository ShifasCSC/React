...
function About() {
  return (
    <>
      ...
      <div id="next-section" className=" mt-60 pb-2 ">
        <h2 className="text-4xl text-purple-300 text-center">ABOUT <span className='text-slate-200'>ME</span></h2>
        <div className='flex flex-wrap'>
          <motion.div whileInView={{opacity:1,delay:3,duration:0.5}} initial={{x:-120,opacity:0}} animate={{ x: 30,opacity:1,transition: { duration:1,delay:1 }}} className='w-full md:w-1/2  '>
          <div className='pic1 flex items-center justify-center'>
            <img src="halfmy.jpg" className='lg:ms-40 sm:me-90 xl:ms-60 2xl:ms-80 border border-white rounded-2xl mt-20' alt="" />
          ...
          <motion.div whileInView={{opacity:1,delay:2,duration:0.5}} initial={{x:120,opacity:0}} animate={{ x: -100,opacity:1,transition:{ duration:1.2,delay:1 }}} className='w-full md:w-1/2'>
          <div className='flex justify-center  md:justify-start'>
            <p  className='my-2 md:max-w-sm md:ms-20 sm:max-w-30 xl:me-40 sm:ms-60 py-8 w-70 text-white tracking-tighter'>
